...
const shortUrl_modal_1 = __importDefault(require("../models/shortUrl.modal"));
function createShortUrl(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        // get the destination from req body
        const { destination } = req.body;
        // Create a shortUrl
        const newUrl = yield shortUrl_modal_1.default.create({ destination });
        // return shortUrl
        res.send(newUrl);
    });
}
...
function handleRedirect(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const short = yield shortUrl_modal_1.default.findOne({ shortId }).lean();
        if (!short) {
